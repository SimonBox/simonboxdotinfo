    ...
    content(){
        return(
            <div>
                ...
                <p>Download <a href="https://eprints.soton.ac.uk/350157/1/sboxutsg13.pdf">this paper</a> to read more about the experiments and its results.</p>
                <h3>Get the data</h3>
                <p>Lots of data were recorded during this experiment from GPS sensors within the vehicles and from track-side bluetooth detectors. If you're interested in the data you can <a href="/data/mira_20120531.zip" download>download it</a></p>
