    ...
    content(){
        return(
            <div>
                ...
                <p>Cambridge Rocketry currently has two releases. The <a href="index.php/rocketry/80-toplevel/projects/rocketry/71-cambridge-rocketry-simulator">Cambridge Rocketry Simulator</a> is a stand alone program with a graphical user interface. The <a href="index.php/rocketry/80-toplevel/projects/rocketry/72-cambridge-rocketry-toolbox">Cambridge Rocketry Toolbox</a> is a set of Octave/Matlab functions which allow you to do all that you can with the Cambridge Rocketry Simulator and more because it is easy to modify the code and add your own functions. The downside is that it is not so user friendly (no GUI) and it runs much slower.</p>
