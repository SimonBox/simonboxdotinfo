    ...
    content(){
        return(
            <div>
                ...
                <p> If you do not know how to use Octave or Matlab, or you would prefer to use more user friendly stand alone software please have a look at the <a href="/cambridge-rocketry-simulator">Cambridge Rocketry Simulator</a>. The toolbox is useful if you would like to extend the functionality by writing your own Ocatave/Matlab code. You can download the latest release of the toolbox from my <a href="/software">software</a> page and the <a href="http://cambridgerocket.sourceforge.net">Cambridge Rocketry website</a>.</p>
