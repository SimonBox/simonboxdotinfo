    ...
    content(){
        return(
            <div>
                ...
                <p>The Cambridge rocketry simulator is currently the main software programme produced by Cambridge rocketry. It is a stand alone rocket simulator that runs under Linux and Windows. It is written in a C++, Java and Python. You can download the latest release or access the source code from my <a href="/software">software</a> page.</p>
                <h3>Functionality</h3>
                ...
                <p>The simulation engine on which the programme is based has been described in a scientific paper published in the Journal of Aerospace Engineering. You can link to this paper from my <a href="/publications">publications</a> page.</p>
                <p>There is also a version of this software called the <a href="cambridge-rocketry-toolbox">Cambridge Rocketry Toolbox</a>, which runs in Octave/Matlab. While the toolbox is slower and less user friendly than the simulator it easy to extend the functionality by writing your own Octave/Matlab code.</p>
